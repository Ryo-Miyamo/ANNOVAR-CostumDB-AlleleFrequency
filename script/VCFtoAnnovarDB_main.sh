...
# Base directory for the VCF-ANNOVARdb-Converter project
# Update this path to point to your local VCF-ANNOVARdb-Converter directory
Home_Dir="/home/user/Research/Tools/VCF-ANNOVARdb-Converter/"
...
# Column name for the AF in your VCF file
# Change this value to the appropriate column name for your dataset (this value will appear in the ANNOVAR .annot files)
colname_ANN="54KJPN_v20230626r3"  # Example value, customize as needed
...
required_scripts=(
    "VCFtoAnnovarDB_main.sh"
    "VCFtoAnnovarDB_indel_converter_DEL.py"
    "VCFtoAnnovarDB_indel_converter_INS.py"
)
...
python "${Home_Dir}script/VCFtoAnnovarDB_indel_converter_DEL.py"
echo "Python script (DEL conversion) executed."

python "${Home_Dir}script/VCFtoAnnovarDB_indel_converter_INS.py"
...
cat "${Tmp_Dir}"*converted.txt | sort -k 1V -k 2n -k 3n | sed '1i#Chr\tStart\tEnd\tRef\tAlt\t'"$colname_ANN" > "${Output_Dir}hg38_${colname_ANN}.txt"
echo "Final output saved to ${Output_Dir}hg38_${colname_ANN}.txt."
